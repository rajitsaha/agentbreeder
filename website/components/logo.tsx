...
export function LogoIcon({ size = 28 }: { size?: number }) {
  return (
    <svg width={size} height={size} viewBox="0 0 36 36" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <circle cx="12" cy="21.5" r="2" fill="#4ade80" opacity="0.7"/>
      <circle cx="24" cy="21.5" r="2" fill="#4ade80" opacity="0.7"/>
      <line x1="18" y1="17" x2="12" y2="12.5" stroke="#22c55e" strokeWidth="1" opacity="0.4"/>
      <line x1="18" y1="17" x2="24" y2="12.5" stroke="#22c55e" strokeWidth="1" opacity="0.4"/>
      <line x1="18" y1="17" x2="12" y2="21.5" stroke="#22c55e" strokeWidth="1" opacity="0.4"/>
      <line x1="18" y1="17" x2="24" y2="21.5" stroke="#22c55e" strokeWidth="1" opacity="0.4"/>
    </svg>
  );
}
